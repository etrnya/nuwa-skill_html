...
> 排除源：知乎、微信公眾號、百度百科
> 可信度標註：⭐⭐⭐ 多方交叉驗證 | ⭐⭐ 單方報道但來源可靠 | ⭐ 傳聞或爭議資訊
...
**背景**：TRON面臨「空氣幣」質疑，需要實際產品和使用者基數來增加可信度。BitTorrent是全球最大的P2P檔案分享協議，擁有超過1億月活使用者。
...
**行動時間線**：
1. **2020年2月14日**：透過TRON基金會以約800萬美元從創始人Ned Scott手中收購Steemit公司，獲得約7000萬STEEM代幣（約佔總供應量20%）
2. **社群反擊**：Steem的驗證者（witnesses）透過軟分叉（Soft Fork 22.2）凍結了孫宇晨持有的STEEM投票權，以保護社群治理
...
- 為FTX上的TRON系代幣（TRX、BTT、JST、SUN、HT）設立1:1兌換信貸額度，允許使用者將TRON系代幣從FTX轉出到外部錢包
...
**SEC指控內容（2023年3月22日）**：
- 透過TRON基金會、BitTorrent基金會、Rainberry Inc.出售未註冊證券（TRX和BTT）
...
- 眾議院民主黨議員致信SEC主席，指出這是「pay-to-play」（付費免罪）
...
| **HT** | 控制（非建立） | 交易所代幣 | 透過控制HTX獲得 | 與HTX繫結 |

**發幣模式特徵**：
1. 每次重大收購或生態擴充套件後都伴隨新代幣發行
2. 通常對標當時熱點（SUN對標YFI，USDD對標UST）
3. 透過TRON生態和個人流量初期拉昇
4. 透過自己控制的交易所（HTX、Poloniex）維持流動性
...
### 模式3：「收購+發幣」閉環
BitTorrent → BTT | Poloniex → 流動性入口 | HTX → HT/交易量 | Steemit → 試圖代幣化（失敗）。模式是：收購有使用者基數的產品 → 在其基礎上發行代幣 → 透過自己控制的交易所維持流動性。
...
公開倡導去中心化網際網路，但實際行為是：控制交易所（HTX、Poloniex）、利用交易所力量奪取社群控制權（Steem）、壓制媒體批評（CoinDesk事件）、透過政治關係影響監管。這是孫宇晨最核心的言行不一致。
...
### 學術/政府來源
- [眾議院民主黨致SEC信函](https://casten.house.gov/imo/media/doc/letter_to_sec_on_justin_sun_september_2025.pdf)
- [眾議院金融服務委員會致SEC信函](https://democrats-financialservices.house.gov/uploadedfiles/01.14.2026_ltr_sec_rfcryptoe.pdf)
