...
| **revolutionary** | 產品定位，iPhone/iPad釋出 | 不是"改進"而是"革命"——框定認知：這不是迭代，是正規化轉移 |
...
[一手] 面試時的壓力測試："God, that really turned out to be a bomb. That really turned out to be a bozo product." ——故意貶低面試者之前的工作，觀察對方是否有堅定信念
...
[二手] 1981年，Apple的軟體工程師Bud Tribble創造了"Reality Distortion Field"（現實扭曲力場）這個說法來描述Jobs的魅力及其對Macintosh開發團隊的效果。這個術語借自《星際迷航》中外星人透過精神力量創造自己現實的概念。

[二手] Andy Hertzfeld的定義：Jobs"能夠用魅力、魄力、誇張、營銷、安撫和執著的混合體，說服自己和周圍的人相信幾乎任何事情"。
...
- 這種絕對確定性具有傳染性——如果演講者自己100%相信，聽眾更容易被帶入

**技術三：情感優先於邏輯**
- [推斷] RDF不靠資料說服人（雖然Jobs也用資料），而是靠**讓你想要相信**。他先啟用你對美好未來的渴望，然後才告訴你技術細節
...
- [推斷] 透過重新定義品類，Jobs讓競品的參照系失效。如果iPhone是三個產品合一，你就沒法拿它跟諾基亞比，因為比較框架不存在
...
雖然這段文案由TBWA\Chiat\Day的Rob Siltanen和Craig Tanimoto團隊創作，但Jobs深度參與了方向定義和文案稽核。文字本身體現了Jobs認同的語言哲學：
...
### 來自《Make Something Wonderful》的一手文字

這本2023年出版的書收錄了Jobs的筆記、草稿、信件、郵件，展現了非演講場合的語言特徵：
...
| **重複錨定** | 透過重複讓關鍵資訊不可遺忘 | "Stay Hungry. Stay Foolish."重複出現在結尾 |
